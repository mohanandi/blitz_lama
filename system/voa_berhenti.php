...
if (isset($_GET['m'])) {
    ...
    $data = "SELECT * FROM voa WHERE id ='$id' " ;
    ...
    $query = "INSERT INTO riwayat_voa VALUE ('id','$nama_pt', '$passport','$visa', '$start_visa', '$expired', '$ket', '$tgl_input', '$input_by', '$tgl_stop', '$stop_by')" ;
    $result = mysqli_query($connection, $query);

    $hapus = "DELETE FROM voa WHERE id = '$id' " ;
    ...
    header("location:../beranda/report?page=voa") ;     
