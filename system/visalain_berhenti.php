...
if (isset($_GET['m'])) {
    ...
    $data = "SELECT * FROM visa_lain WHERE id ='$id' " ;
    ...
    $query = "INSERT INTO riwayat_visa_lain VALUE ('id','$nama_pt', '$passport','$visa', '$start_visa', '$expired', '$ket', '$tgl_input', '$input_by', '$tgl_stop', '$stop_by')" ;
    $result = mysqli_query($connection, $query);

    $hapus = "DELETE FROM visa_lain WHERE id = '$id' " ;
    ...
    header("location:../beranda/report?page=visa_lain") ;     
