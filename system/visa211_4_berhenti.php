...
if (isset($_GET['m'])) {
    ...
    $data = "SELECT * FROM visa211_4 WHERE id ='$id' " ;
    ...
    $query = "INSERT INTO riwayat_visa211_4 VALUE ('id','$nama_pt', '$passport','$visa', '$start_visa', '$expired', '$ket', '$tgl_input', '$input_by', '$tgl_stop', '$stop_by')" ;
    $result = mysqli_query($connection, $query);

    $hapus = "DELETE FROM visa211_4 WHERE id = '$id' " ;
    $query_hapus = mysqli_query($connection, $hapus) ;


    //-------------------------------------------------------------------------

    $dat = "SELECT * FROM visa211_3 WHERE passport = '$passport' " ;
    ...
    $visa = $row_visa['visa'] ;
    $start_visa = $row_visa['start_visa'] ;
    $expired = $row_visa['expired'] ;
    $ket = $row_visa['ket'] ;
    $tgl_input = $row_visa['tgl_input'] ;
    $input_by = $row_visa['input_by'] ;


    $query = "INSERT INTO riwayat_visa211_3 VALUE ('id','$nama_pt', '$passport','$visa', '$start_visa', '$expired', '$ket', '$tgl_input', '$input_by', '$tgl_stop', '$stop_by')" ;
    $result = mysqli_query($connection, $query);

    $hapus = "DELETE FROM visa211_3 WHERE id = '$id_baru' " ;
    $query_hapus = mysqli_query($connection, $hapus) ;

    //--------------------------------------------------------------------------


    $dat = "SELECT * FROM visa211_2 WHERE passport = '$passport' " ;
    $hasil_dat = mysqli_query($connection, $dat) ;
    $row_visa = mysqli_fetch_assoc($hasil_dat) ;
    ...
    $query = "INSERT INTO riwayat_visa211_2 VALUE ('id','$nama_pt', '$passport','$visa', '$start_visa', '$expired', '$ket', '$tgl_input', '$input_by', '$tgl_stop', '$stop_by')" ;
    $result = mysqli_query($connection, $query);

    $hapus = "DELETE FROM visa211_2 WHERE id = '$id_baru' " ;
    $query_hapus = mysqli_query($connection, $hapus) ;


    //----------------------------------------------------------------------------------
    $dat = "SELECT * FROM visa211_1 WHERE passport = '$passport' " ;
    $hasil_dat = mysqli_query($connection, $dat) ;
    $row_visa = mysqli_fetch_assoc($hasil_dat) ;
    ...
    $query = "INSERT INTO riwayat_visa211_1 VALUE ('id','$nama_pt', '$passport','$visa', '$start_visa', '$expired', '$ket', '$tgl_input', '$input_by', '$tgl_stop', '$stop_by')" ;
    $result = mysqli_query($connection, $query);

    $hapus = "DELETE FROM visa211_1 WHERE id = '$id_baru' " ;
    $query_hapus = mysqli_query($connection, $hapus) ;


    //----------------------------------------------------------------------------------
    $dat = "SELECT * FROM visa211 WHERE passport = '$passport' " ;
    $hasil_dat = mysqli_query($connection, $dat) ;
    $row_visa = mysqli_fetch_assoc($hasil_dat) ;
    ...
    $hapus = "DELETE FROM visa211 WHERE id = '$id_baru' " ;
    $query_hapus = mysqli_query($connection, $hapus) ;
    ...
    header("location:../beranda/report?page=visa211_4") ;     
}