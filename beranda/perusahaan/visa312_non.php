<div class="container" style="margin-top:101px;">
    <h2>
        <center>DATA VISA 312 NON-AKTIF <br> <?php echo $nama_pt; ?> </center>
    </h2>
...
function seluruh($nama_pt)
{
    ...
    $query = "SELECT * FROM riwayat_visa312 WHERE nama_pt = '$nama_pt'";
...
?>
        <tr>
            ...
            <td><?php echo $row_imta['no_rptka'];  ?></td>
            <td><?php echo $row_imta['jabatan'];  ?></td>
            <td><?php echo $row_imta['tgl_terbit'];  ?></td>
            <td><?php echo $row_imta['no_imta'];  ?></td>
            <td><?php echo $row_imta['exp_kitas'];  ?></td>
            <td><?php echo $row_imta['notif'];  ?></td>
