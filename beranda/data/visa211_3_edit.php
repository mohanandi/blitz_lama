...
<div class="container" style="margin-top:101px;"><center><h2> Edit VISA 211-3 <?php echo $row['nama_latin'] ; ?> </h2></center>
<hr class="colorgraph">
...
<table id="tab" class="table table-hover table-bordered" style="width:60%;margin-top:50px;" >
    <form method="post" action= "../../system/visa211_3_edit.php">
    ...
    <tr>
      <th> Keterangan</th>
      <td><input id="fc1" type="text" name = "ket" class="form-control"  value = "<?php echo $visa['ket'] ; ?>"  oninvalid="alert('Masukan Tanggal Expired Visa');" required/></td>
    </tr>
    <tr>
