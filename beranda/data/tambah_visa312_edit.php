...
<div class="container" style="margin-top:101px;"><h2><center>Edit Visa 312 </center> </h2>
<hr class="colorgraph">
<?php
...
<table id="tab" class="table table-hover table-bordered" style="width:60%;margin-top:50px;" >
    ...
    <input type = "hidden" class="form-control" name = "rptka_lama" value = "<?php $rptka_lama ;?>">
    <input type = "hidden" class="form-control" name = "jabatan" value = "<?php $jabatan ;?>">
    ...
    <th width="40%"> No RPTKA </th>
        <td><select name="rptka_baru" id="rptka_baru" class="form-control">
                        <?php
                      ...
                      ?>
                            ...
                            <option selected><?php echo "$rptka_baru"; ?></option>
