...
<div class="container" style="margin-top:101px;"><center><h2> Record VISA 211 <?php echo $row['nama_latin'] ; ?> </h2></center>
<hr class="colorgraph">
...
<table id="tab" class="table table-hover table-bordered" style="width:60%;margin-top:50px;" >
    ...
    <tr>
      <th colspan="2"> <a href="../data?page=visa211_edit&passport=<?php echo $passport ?>">Edit</a></th>
