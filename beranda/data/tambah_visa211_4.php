...
<div class="container" style="margin-top:101px;"><center><h2> Input VISA 211-4 <?php echo $row['nama_latin'] ; ?> </h2></center>
<hr class="colorgraph">
...
<table id="tab" class="table table-hover table-bordered" style="width:60%;margin-top:50px;" >
    <form method="post" action= "../../system/buat_visa211_4.php">
    ...
    <tr>
      ...
      <td><input id="fc1" type="date" name = "start_visa"  class="form-control"  /></td>
    </tr>
    <tr>
      <th> Tanggal Akhir Visa</th>
      <td><input id="fc1" type="date" name = "expired" class="form-control" /></td>
    </tr>
