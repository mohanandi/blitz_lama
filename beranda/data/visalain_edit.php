...
<center><h2> EDIT Visa Lain <?php echo $row['nama_latin'] ; ?> </h2></center>
<hr class="colorgraph">
...
<table id="tab" class="table table-hover table-bordered" style="width:60%;margin-top:50px;" >
    <form method="post" action= "../../system/visalain_edit.php">
    ...
    <tr>
    <th colspan="2"><input type = "submit" value="Submit" name="submit"  class="btn btn-primary btn-block btn-lg" style="height:40px;"></th>
    </tr>
  </form>
</table>
    </div>