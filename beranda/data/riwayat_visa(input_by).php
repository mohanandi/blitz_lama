...
<center> <h2> RIWAYAT INPUT VISA </h2></center>
  ...
  <div class="scrollable-table">
    ...
    <table class="table table-hover table-bordered results" >
      ...
      if(isset($_POST['submit_filter'])){
        ...
        if ($filter_by=="visa211"){
          ?>
          
        <?php
          $query = "SELECT * FROM visa211 WHERE input_by = '$nama_user'" ;
        ...
        <tr>
          ...
          <td><a href = "../data?page=visa211_edit&passport=<?php echo $data_tka['passport']; ?>"><?php echo $data_tka['nama_latin'] ;  ?></a></td>
        ...
        <?php } }
          ...
          $query = "SELECT * FROM visa211_1 WHERE input_by = '$nama_user'" ;
            $result = mysqli_query ($connection, $query) ;
        ...
        <tr>
          ...
          <td><?php echo $data_tka['nama_pt'] ;  ?></td>
          <td><?php echo $data_tka['nama_mandarin'] ;  ?></td>
          <td><a href = "../data?page=visa211_1_edit&passport=<?php echo $data_tka['passport']; ?>"><?php echo $data_tka['nama_latin'] ;  ?></a></td>
          <td><?php echo $data_tka['kewarganegaraan'] ;  ?></td>
          <td><?php echo $data_tka['passport'] ;  ?></td>
          <td><?php echo $data_tka['expired_passport'] ;  ?></td>
          <td><?php echo $data_tka['tgl_lahir'] ;  ?></td>
        ...
        <?php } } 
          ...
          $query = "SELECT * FROM visa211_2 WHERE input_by = '$nama_user'" ;
          $result = mysqli_query ($connection, $query) ;
      ...
      <tr>
        ...
        <td><?php echo $data_tka['nama_pt'] ;  ?></td>
        <td><?php echo $data_tka['nama_mandarin'] ;  ?></td>
        <td><a href = "../data?page=visa211_2_edit&passport=<?php echo $data_tka['passport']; ?>"><?php echo $data_tka['nama_latin'] ;  ?></a></td>
        <td><?php echo $data_tka['kewarganegaraan'] ;  ?></td>
        <td><?php echo $data_tka['passport'] ;  ?></td>
        <td><?php echo $data_tka['expired_passport'] ;  ?></td>
        <td><?php echo $data_tka['tgl_lahir'] ;  ?></td>
      ...
      <?php } } 
          ...
          $query = "SELECT * FROM visa211_3 WHERE input_by = '$nama_user'" ;
            $result = mysqli_query ($connection, $query) ;
        ...
        <tr>
          ...
          <td><?php echo $data_tka['nama_pt'] ;  ?></td>
          <td><?php echo $data_tka['nama_mandarin'] ;  ?></td>
          <td><a href = "../data?page=visa211_3_edit&passport=<?php echo $data_tka['passport']; ?>"><?php echo $data_tka['nama_latin'] ;  ?></a></td>
          <td><?php echo $data_tka['kewarganegaraan'] ;  ?></td>
          <td><?php echo $data_tka['passport'] ;  ?></td>
          <td><?php echo $data_tka['expired_passport'] ;  ?></td>
          <td><?php echo $data_tka['tgl_lahir'] ;  ?></td>
        ...
        <?php } } 
          ...
          $query = "SELECT * FROM visa211_4 WHERE input_by = '$nama_user'" ;
            $result = mysqli_query ($connection, $query) ;
        ...
        <tr>
          ...
          <td><?php echo $data_tka['nama_pt'] ;  ?></td>
          <td><?php echo $data_tka['nama_mandarin'] ;  ?></td>
          <td><a href = "../data?page=visa211_4_edit&passport=<?php echo $data_tka['passport']; ?>"><?php echo $data_tka['nama_latin'] ;  ?></a></td>
          <td><?php echo $data_tka['kewarganegaraan'] ;  ?></td>
          <td><?php echo $data_tka['passport'] ;  ?></td>
          <td><?php echo $data_tka['expired_passport'] ;  ?></td>
          <td><?php echo $data_tka['tgl_lahir'] ;  ?></td>
        ...
        <?php } }
          ...
          $query = "SELECT * FROM visa312 WHERE input_by = '$nama_user'" ;
            $result = mysqli_query ($connection, $query) ;
        ...
        <tr>
          ...
          <td><?php echo $data_tka['nama_pt'] ;  ?></td>
          <td><?php echo $data_tka['nama_mandarin'] ;  ?></td>
          <td><a href = "../data?page=visa312_edit&passport=<?php echo $data_tka['passport']; ?>"><?php echo $data_tka['nama_latin'] ;  ?></a></td>
          <td><?php echo $data_tka['kewarganegaraan'] ;  ?></td>
          <td><?php echo $data_tka['passport'] ;  ?></td>
          <td><?php echo $data_tka['expired_passport'] ;  ?></td>
          <td><?php echo $data_tka['tgl_lahir'] ;  ?></td>
        ...
        <?php } }
          ...
          <tr>
          <td colspan="11" style="text-align:center">VISA 211</td>
          </tr>
        ...
        <?php } }
          ?>
          <tr>
          <td colspan="11" style="text-align:center">VISA 211-1</td>
          </tr>
          <?php
          $query = "SELECT * FROM visa211_1 WHERE input_by = '$nama_user'" ;
            $result = mysqli_query ($connection, $query) ;
        ...
        <?php } } ?>
          ...
          <tr>
          <td colspan="11" style="text-align:center">VISA 211-2</td>
        </tr>
        ...
        <?php } } ?>
          ...
          <tr>
          <td colspan="11" style="text-align:center">VISA 211-3</td>
        </tr>
        ...
        <?php } } ?>
          ...
          <tr>
          <td colspan="11" style="text-align:center">VISA 211-4</td>
        </tr>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="form-group">
            ...
            <div><select name="filter" class="form-control" style="width:100%;"> 
        ...
        <div class="modal-footer">
            <input type="submit" name="submit_filter" class="btn btn-primary btn-md" value="Cari" style="margin-left:0px;">             </div>
        </div>
